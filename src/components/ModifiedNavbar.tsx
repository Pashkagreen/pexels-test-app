...
const ModifiedNavbar: React.FC = () => {
    ...
    return (
        <>
            <nav className='navbar' style={{paddingRight: '20px',width:'100%', position:'fixed', top:'0', backgroundColor: '#242222' , zIndex: '200' }} >
                ...
                <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                    <li className='nav-item'><Link to='/search' className='nav-links' onClick={closeMobileMenu}>
                        Найти фото
                    </Link></li>
